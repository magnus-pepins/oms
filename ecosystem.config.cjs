...
const INGRESS_BENCH_ENV = {
  ...
  // Slice 4r: outbox reconciler bulk POST (async accept path stays fire-and-forget).
  OMS_LEDGER_INFLIGHT_OUTBOX_BULK_ENABLED: 'true',
...
const apps = [
  ...
  },
  {
    ...
    env: {
      ...
      // Pop bench throughput: skip redundant projector GET /balances when ingress pre-admit hold ran.
      ...
      // Pop bench: only retail demo account(s) fan out to NATS; burst load-test UUIDs skip outbox.
      OMS_DOMAIN_FANOUT_ACCOUNT_ALLOWLIST:
        process.env.OMS_DOMAIN_FANOUT_ACCOUNT_ALLOWLIST
        || 'ee69e1be-c1f1-4dfa-b3e8-2ecd9fb90970',
  ...
  },
  {
    ...
    env: {
      ...
      OMS_CLUSTER_VENUE_EGRESS_REPLAY_LAG_ADAPTIVE_EXCESS_LAG_BYTES_THRESHOLD: '4096',
      OMS_CLUSTER_VENUE_EGRESS_REPLAY_LAG_ADAPTIVE_PENDING_ROUTES_THRESHOLD: '256',
      OMS_CLUSTER_VENUE_EGRESS_REPLAY_LAG_ADAPTIVE_FRAGMENT_LIMIT: '8192',
      OMS_CLUSTER_VENUE_EGRESS_REPLAY_LAG_ADAPTIVE_IDLE_TAIL_POLLS: '64',
      ...
      OMS_CLUSTER_VENUE_EGRESS_BACKLOG_THROTTLE_MAX_IN_FLIGHT: '576',
      OMS_CLUSTER_VENUE_EGRESS_BACKLOG_THROTTLE_ER_SOFT_CAP_PERMIT_MULTIPLIER: '4',
      OMS_CLUSTER_VENUE_EGRESS_BACKLOG_THROTTLE_ER_EXHAUSTED_CAP_PERMIT_MULTIPLIER: '3',
      OMS_CLUSTER_VENUE_EGRESS_BACKLOG_THROTTLE_PARK_NANOS: '1000',
      OMS_CLUSTER_CLIENT_ER_OFFER_MAX_PER_LOCK_PASS: '1024',
      OMS_CLUSTER_CLIENT_ER_OFFER_DRAIN_INTERVAL_NANOS: '1000',
      OMS_CLUSTER_CLIENT_ER_OFFER_INTERLEAVE_POLL_CAP: '8',
      OMS_CLUSTER_CLIENT_ER_OFFER_INTERLEAVE_POLL_EVERY_OFFERS: '4',
      OMS_CLUSTER_CLIENT_ER_OFFER_INTERLEAVE_LAG_AWARE_ENABLED: 'true',
      OMS_CLUSTER_CLIENT_ER_OFFER_INTERLEAVE_LAG_BYTES_THRESHOLD: '4096',
      OMS_CLUSTER_CLIENT_ER_OFFER_INTERLEAVE_LAG_AWARE_QUEUE_DEPTH_THRESHOLD: '256',
      OMS_CLUSTER_CLIENT_ER_OFFER_INTERLEAVE_LAG_AWARE_POLL_EVERY_OFFERS: '1',
      OMS_CLUSTER_CLIENT_ROLE: 'er-offer-only',
