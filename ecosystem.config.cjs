...
const apps = [
  ...
  },
  {
    ...
    env: {
      ...
      OMS_CLUSTER_VENUE_EGRESS_VENUE_ROUTE_MAX_IN_FLIGHT: '640',
      ...
      OMS_CLUSTER_VENUE_EGRESS_BACKLOG_THROTTLE_MAX_IN_FLIGHT: '640',
      OMS_CLUSTER_VENUE_EGRESS_BACKLOG_THROTTLE_ER_SOFT_CAP_PERMIT_MULTIPLIER: '5',
