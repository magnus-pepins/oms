...
/**
 * Phase 0 entrypoint of {@code system-documentation/plans/oms-aeron-cluster-substrate.md}: same
 * Spring Boot application as {@link OmsApplication} with profile
 * {@value OmsProfiles#VENUE_EGRESS} added.
 *
 ...
 * once slice 3g lands).
 *
 * <p>Local: {@code ./gradlew bootRunVenueEgress}. Containers may also use
 * {@code java -jar oms.jar --spring.profiles.include=oms-venue-egress}.
 */
public final class OmsVenueEgressBootstrap {

    private OmsVenueEgressBootstrap() {}

    public static void main(String[] args) {
        SpringApplication application = new SpringApplication(OmsApplication.class);
        application.setAdditionalProfiles(OmsProfiles.VENUE_EGRESS);
