 ...
 *
 * <p>Phase 3 slice 3g of the Aeron Cluster substrate plan retired the legacy in-memory outbound queue
 * ({@code FixOutboundDispatchWorker} + {@code FixRouteDispatcher}); wire sends now go directly through
 * {@link FixOutboundSessionSend#send} on the calling thread. The serialised-through-queue path is gone.
 */
@Service
