...
@Repository
public class BrokerSettlementFailBatchRepository {
    ...
    private static final String COMMON_SELECT =
            """
                    SELECT id, broker_id, broker_file_id, business_date, schema_version,
                           ...
                           parsed_at, status, fail_count, error_summary
                    FROM broker_settlement_fail_batch
                    """;

    private static final String UPDATE_STATUS =
            """
                    UPDATE broker_settlement_fail_batch
                    SET status = :st,
                        fail_count = COALESCE(:fc, fail_count),
    ...
    public BrokerSettlementFailBatchRepository(NamedParameterJdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
    ...
    private static BatchRow mapRow(java.sql.ResultSet rs) throws java.sql.SQLException {
        ...
        return new BatchRow(
                ...
                rs.getString("status"),
                (Integer) rs.getObject("fail_count"),
