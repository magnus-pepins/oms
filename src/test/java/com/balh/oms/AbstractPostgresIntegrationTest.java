...
public abstract class AbstractPostgresIntegrationTest {
     ...
     * (see {@code FixSessionStoreDataSourceConfiguration}); {@code build.gradle.kts} sets
     * {@code spring.test.context.cache.maxSize} to {@code 1} on GitHub Actions (else {@code 10} locally)
     * so at most one loaded {@code ApplicationContext} is retained, closing prior pools before the next IT.
     *
